"""Calculates the Frechet Inception Distance (FID) to evalulate images
...
"""
Above code is from https://github.com/mseitzer/pytorch-fid/blob/master/pytorch_fid
"""
...
def main():
    ...
    path1 = "PeerReport/MNIST/Peer_reference/1"
    path2 = f"PeerReport/MNIST/{noise_type}/{epsi}/{epsi}/1"
